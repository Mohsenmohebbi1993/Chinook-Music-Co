...
│
├── pyproject.toml     <- Project configuration file with package metadata for music_co
...
│
└── music_co                <- Source code for use in this project.
    │
    ├── __init__.py    <- Makes music_co a Python module
    │
